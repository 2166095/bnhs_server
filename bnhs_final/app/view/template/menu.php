...
switch($page[0]) {
	...
	case 'student' :
		...
		echo '<li '.$this->helpers->isActiveMenu("student-accounts").'><a href="'.URL.'student-accounts"><i class="fas fa-list-ul"></i>Statement of Account</a></li>';
		echo '<li '.$this->helpers->isActiveMenu("student-attendance").'><a href="'.URL.'student-attendance"><i class="far fa-calendar-alt"></i>Attendance</a></li>';
		echo '<li '.$this->helpers->isActiveMenu("student-grades").'><a href="'.URL.'student-grades"><i class="fas fa-calendar-check"></i>Grades</a></li>';
		echo '<li '.$this->helpers->isActiveMenu("student-schedule").'><a href="'.URL.'student-schedule"><i class="fas fa-clipboard-list fnt"></i>Class Schedule</a></li>';
	...
	case 'parent' :
		...
		echo '<li '.$this->helpers->isActiveMenu("parent-grades").'><a href="'.URL.'parent-grades"><i class="fas fa-book-open"></i>Child Grades</a></li>';
		echo '<li '.$this->helpers->isActiveMenu("parent-schedule").'><a href="'.URL.'parent-schedule"><i class="fas fa-clipboard-list fnt"></i>Class Schedule</a></li>';
		break;
	case 'treasurer':
